...
WAKEUP_CONFIG = {
    "refresh_time": 10,
    "responses": [
        "I'm always here, please speak.",
        "I'm here, please feel free to tell me.",
...
async def checkWakeupWords(conn, text):
    ...
    # Wait for TTS initialization, wait up to 3 seconds
    ...
    conn.logger.bind(tag=TAG).info(f"Playing wakeup word response: {response.get('text')}")
...
async def wakeupWordsResponse(conn):
    ...
    try:
        ...
        # Randomly select a response from predefined response list
